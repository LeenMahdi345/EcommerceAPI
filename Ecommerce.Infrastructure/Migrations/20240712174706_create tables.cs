...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    public partial class createtables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Category_Id", "Image", "Name", "Price", "categoryId" },
                values: new object[,]
                {
                    { 1, 1, "smartphone.jpg", "Smartphone", 299.99m, null },
                    { 2, 1, "laptop.jpg", "Laptop", 799.99m, null },
                    { 3, 2, "novel.jpg", "Novel", 19.99m, null },
                    { 4, 3, "tshirt.jpg", "T-Shirt", 9.99m, null },
                    { 5, 3, "jeans.jpg", "Jeans", 49.99m, null }
                });
